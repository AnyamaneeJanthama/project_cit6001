                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-end">
                                    <a href="crud_employee.php?xCase=1" class="btn btn-primary"><i
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="crud_employee.php?xCase=4&id=<?php echo $row['emp_id'] ?>"
                                                        name="btn_view" class="btn btn-info"><i
                                                            class="fa-solid fa-address-card"></i></a>
                                                    <a href="crud_employee.php?xCase=2&id=<?php echo $row['emp_id'] ?>"
                                                        name="btn_edit" class="btn btn-warning edit_sale"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="crud_employee.php?xCase=3&id=<?php echo $row['emp_id'] ?>"
